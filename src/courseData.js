...
// Para publicar un recurso, agrega un objeto al arreglo `resources` de su clase:
// { name: 'Presentación clase 1', type: 'pdf', href: '/recursos/clase-1/presentacion.pdf', size: '2.4 MB' }
// Tipos disponibles en la interfaz: pdf, txt, link y file.
